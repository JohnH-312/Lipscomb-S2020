...
-H 'Accept-Language: en-US,en;q=0.9' -H 'Cookie: PHPSESSID=drrtdqh9vp76rrjsk2fmgnacf4' --compressed | grep standings
...
-H 'Accept-Language: en-US,en;q=0.9' -H 'Cookie: PHPSESSID=drrtdqh9vp76rrjsk2fmgnacf4' --compressed | grep Hello
...
-H 'Sec-Fetch-User: ?1' -H 'Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9' 
-H 'Sec-Fetch-Site: same-origin' -H 'Sec-Fetch-Mode: navigate' -H 'Referer: http://localhost:8000/' -H 'Accept-Encoding: gzip, deflate, br' 
-H 'Accept-Language: en-US,en;q=0.9' -H 'Cookie: PHPSESSID=drrtdqh9vp76rrjsk2fmgnacf4' --compressed | grep Sample
...
-H 'Sec-Fetch-Site: same-origin' -H 'Sec-Fetch-Mode: navigate' -H 'Referer: http://localhost:8000/' -H 'Accept-Encoding: gzip, deflate, br' 
-H 'Accept-Language: en-US,en;q=0.9' -H 'Cookie: PHPSESSID=drrtdqh9vp76rrjsk2fmgnacf4' --compressed | grep Language
...
-H 'Cookie: PHPSESSID=drrtdqh9vp76rrjsk2fmgnacf4' --compressed | grep Submit
